            ...
            <div className="row">
              <div className="col-12 col-md-4 px-0 px-md-2">
                <div className={styles.cardinfo}>
                  ...
                  <p>
                    A community driven eccommerce bookstore for readers who
                    value supporting book businesses and keeping local dollars
                    local.
                  </p>
                  <p>
              ...
              <div className="col-12 col-md-4 px-0 px-md-2">
                <div className={styles.cardinfo}>
                  ...
                  <p>
                    Search for your desired book and if a bookstore has the book
                    in stock, you can 'request to buy' the book for pick up or
                    delivery.{" "}
                  </p>
                  <p>
                    If no bookstore has the book you are looking for, then place
                    a 'request a book' with the nearest bookstore to you and
                    they will seek out the book on your behalf.
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-4 px-0 px-md-2">
              ...
              <div className="col-12 col-md-4 col-lg-3 px-0 px-md-2 px-md-2">
                <div className={styles.share_btn}>
                  <Link href="" className={`rounded-pill ${styles.dark_color}`}>
                    Share this Page
                  </Link>
                </div>
              </div>

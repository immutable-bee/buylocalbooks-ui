...
// TODO: this page and bookdetail page will be folded into one page "/detail", page will only be accessed using query param "id" - E.G.  "/detail?id={prisma.listing.id}" the page will utilize the BookDetailView component. When a user clicks a book the prisma id for the book will be passed to /detail as a query param. The page will then use the id to query the prisma db for the book details and render the BookDetailView component with the data.
